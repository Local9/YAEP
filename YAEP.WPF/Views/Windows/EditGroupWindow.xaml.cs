...
namespace YAEP.Views.Windows
{
    ...
    /// </summary>
    public partial class EditGroupWindow : FluentWindow
    {
        ...
        public EditGroupWindow(ClientGroupingViewModel viewModel)
        {
            ...
            this.PreviewKeyDown += EditGroupWindow_PreviewKeyDown;
        ...
        private void EditGroupWindow_PreviewKeyDown(object sender, KeyEventArgs e)
        {
