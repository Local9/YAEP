...
{
    public partial class GridLayoutViewModel : ObservableObject, INavigationAware
    {
        ...
        [RelayCommand]
        private void OnApplyGridLayout()
        {
            if (GridPreview == null || GridPreview.Count == 0)
            {
                System.Windows.MessageBox.Show(
                    "No thumbnails to arrange in grid layout.",
                    "Grid Layout",
            ...
            {
                System.Windows.MessageBox.Show(
                    "No active profile found. Please select a profile in Settings.",
                    "Grid Layout",
                    System.Windows.MessageBoxButton.OK,
            ...
            MessageBoxResult result = System.Windows.MessageBox.Show(
                $"This will update {GridPreview.Count} thumbnail(s) with the grid layout settings.\n\n" +
                $"Grid Cell Size: {GridCellWidth}x{GridCellHeight}\n" +
                $"Grid Start Position: ({GridStartX}, {GridStartY})\n" +
            ...
            if (result == System.Windows.MessageBoxResult.Yes)
            {
                ...
                try
                {
                    ...
                    {
                        System.Windows.MessageBox.Show(
                            $"Successfully applied grid layout to {successCount} thumbnail(s).",
                            "Grid Layout",
                            System.Windows.MessageBoxButton.OK,
                            System.Windows.MessageBoxImage.Information);
                    }
                    ...
                    {
                        System.Windows.MessageBox.Show(
                            $"Applied grid layout to {successCount} thumbnail(s).\n\n" +
