...
{
    public partial class ClientGroupingViewModel : ObservableObject, INavigationAware
    {
        ...
        private System.Windows.Window? _editGroupWindow;
        ...
        [RelayCommand]
        private void OnDeleteGroup(DatabaseService.ClientGroup? group)
        {
            if (group == null)
                return;

            MessageBoxResult result = System.Windows.MessageBox.Show(
                $"Are you sure you want to delete group '{group.Name}'? This will remove all clients from the group, but the clients themselves will remain.",
                "Delete Group",
        ...
        /// </summary>
        public void HandleCapturedHotkey(Key key, ModifierKeys modifiers)
        {
